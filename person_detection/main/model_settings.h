...
constexpr int kBaketballIndex = 0;
constexpr int kSoccerIndex = 1;
constexpr int kRugbyIndex = 2;
constexpr int kTableTennisIndex = 3;
constexpr int kTennisIndex = 4;
constexpr int kVolleyballIndex = 5;
